...
const Products = () => {
  ...
  const productsData = [
    ...
    { name: "Reflective Signs", category: "Road Safety Products", img: "/sign.jpg", desc: "Glow-in-dark safety signage.", icon: <TriangleAlert size={80} />, features: ["High-intensity retroreflective sheet", "Durable aluminum backing", "Long-lasting performance", "Easy installation", "Mutiple hazard symbols"] },
