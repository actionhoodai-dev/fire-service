...
const FloatingActions = () => {
  return (
    <>
      {/* Vertically Pinned Side Call-to-Actions (Desktop Only) */}
      <Link to="/contact" className="side-tab-left">
        <CalendarRange size={16} />
        <span>Enquire Now</span>
      </Link>

      <a href="tel:+919944677149" className="side-tab-right">
        <Phone size={16} />
        <span>Support</span>
      </a>

      {/* Bottom Floating Action Buttons */}
      <div className="floating-actions-container" style={{ position: 'fixed', bottom: '40px', right: '40px', zIndex: 1000, display: 'flex', flexDirection: 'column', gap: '15px' }}>
        {/* Call Button */}
        <motion.a 
          ...
          style={{ 
            ...
            boxShadow: '0 8px 16px rgba(204, 0, 0, 0.4)',
            textDecoration: 'none'
          }}
        >
          <Phone size={24} />
